...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  box-sizing: border-box;\n}\n:root {\n  --font-sz: 2rem;\n  --accent1: #1a2238;\n  --accent2: #a0aecd;\n  --titleFN-sz: 1.75rem;\n}\nbody {\n  font-family: \"Source Sans Pro\", sans-serif;\n  background-color: var(--accent2);\n}\n\n.title-pane {\n  background-color: var(--accent1);\n  display: flex;\n  justify-content: center;\n  flex-direction: row;\n  color: white;\n  font-weight: 700;\n  font-style: italic;\n}\n.logo-text-cont {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n}\n.title-Img {\n  width: var(--font-sz);\n  height: var(--font-sz);\n}\n.title-Img.left {\n  margin-right: 15px;\n}\n.title-Img.right {\n  margin-left: 15px;\n}\n.title-text {\n  font-size: var(--font-sz);\n}\n\n.search-card {\n  min-width: 450px;\n  max-width: 500px;\n  padding: 20px;\n  border-radius: 10px;\n  margin: 10px;\n  margin-top: 35px;\n  height: fit-content;\n}\n.shadow-main {\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.19), 0 6px 6px rgba(0, 0, 0, 0.23);\n}\n.search-param {\n  display: flex;\n  flex-direction: column;\n  font-weight: 400;\n  font-size: 1.5rem;\n  margin-top: 15px;\n}\n.search-io {\n  outline: none;\n  border: none;\n  margin-top: 6px;\n  border-bottom: var(--accent1) 2px solid;\n  color: #37497c;\n  padding: 8px 16px;\n  font-size: 1rem;\n}\n.search-title {\n  color: var(--accent1);\n  border-bottom: var(--accent1) 1px solid;\n  font-size: 1.25rem;\n}\n.search-submit-cont {\n  margin-top: 15px;\n  display: flex;\n  justify-content: center;\n}\n#search-submit {\n  border: none;\n  text-align: right;\n  font-weight: 800;\n  text-align: center;\n  font-size: 1.2rem;\n  padding: 15px 25px;\n  background-color: #eba63f;\n}\n#search-submit:hover {\n  background-color: #e40c2b;\n  color: white;\n  padding: 13px 23px;\n  border: var(--accent1) 2px solid;\n}\n.weather-card {\n  min-width: 550px;\n  max-width: 700px;\n  padding: 20px;\n  border-radius: 10px;\n  margin: 10px;\n  margin-top: 35px;\n  background-color: var(--accent1);\n  color: white;\n}\n.weather-card-title {\n  font-size: var(--titleFN-sz);\n  padding-bottom: 10px;\n}\n\n.weather-image-cont {\n  margin: 20px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\n.weather-card-weather-image {\n  --img-sz: 10rem;\n  width: var(--img-sz);\n  height: var(--img-sz);\n  background-color: white;\n  border-radius: 10px;\n}\n\n.weather-image-descrip {\n  font-size: 1.2rem;\n}\n\n.main-flex {\n  display: flex;\n  gap: 10px;\n  justify-content: center;\n}\n.info-flex {\n  display: flex;\n  flex-direction: row;\n}\n.info-col {\n  min-width: 50%;\n  padding: 10px;\n}\n.info-col.left {\n  text-align: right;\n  border-right: white 2px solid;\n  padding-right: 20px;\n}\n.info-col.right {\n  text-align: left;\n  padding-left: 20px;\n}\n.info-col-title {\n  font-size: 1.2rem;\n}\n.temp-text {\n  font-size: 5rem;\n}\n\n.weather-title-flex {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  border-bottom: var(--accent2) 1px solid;\n}\n#tempSwap {\n  height: var(--titleFN-sz);\n  background-color: #fff;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  font-weight: bold;\n  margin-bottom: 5px;\n}\n#tempSwap:hover{\n  color: black;\n  background-color: #eba63f;\n}\n\n\n", "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;EACE,sBAAsB;AACxB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,kBAAkB;EAClB,qBAAqB;AACvB;AAEA;EACE,0CAA0C;EAC1C,gCAAgC;AAClC;;AAEA;EACE,gCAAgC;EAChC,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,YAAY;EACZ,gBAAgB;EAChB,kBAAkB;AACpB;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,mBAAmB;AACrB;AACA;EACE,qBAAqB;EACrB,sBAAsB;AACxB;AACA;EACE,kBAAkB;AACpB;AACA;EACE,iBAAiB;AACnB;AACA;EACE,yBAAyB;AAC3B;;AAEA;EACE,gBAAgB;EAChB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;EACnB,YAAY;EACZ,gBAAgB;EAChB,mBAAmB;AACrB;AACA;EACE,0EAA0E;AAC5E;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;AAClB;AACA;EACE,aAAa;EACb,YAAY;EACZ,eAAe;EACf,uCAAuC;EACvC,cAAc;EACd,iBAAiB;EACjB,eAAe;AACjB;AACA;EACE,qBAAqB;EACrB,uCAAuC;EACvC,kBAAkB;AACpB;AACA;EACE,gBAAgB;EAChB,aAAa;EACb,uBAAuB;AACzB;AACA;EACE,YAAY;EACZ,iBAAiB;EACjB,gBAAgB;EAChB,kBAAkB;EAClB,iBAAiB;EACjB,kBAAkB;EAClB,yBAAyB;AAC3B;AACA;EACE,yBAAyB;EACzB,YAAY;EACZ,kBAAkB;EAClB,gCAAgC;AAClC;AACA;EACE,gBAAgB;EAChB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;EACnB,YAAY;EACZ,gBAAgB;EAChB,gCAAgC;EAChC,YAAY;AACd;AACA;EACE,4BAA4B;EAC5B,oBAAoB;AACtB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,oBAAoB;EACpB,qBAAqB;EACrB,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,SAAS;EACT,uBAAuB;AACzB;AACA;EACE,aAAa;EACb,mBAAmB;AACrB;AACA;EACE,cAAc;EACd,aAAa;AACf;AACA;EACE,iBAAiB;EACjB,6BAA6B;EAC7B,mBAAmB;AACrB;AACA;EACE,gBAAgB;EAChB,kBAAkB;AACpB;AACA;EACE,iBAAiB;AACnB;AACA;EACE,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,uCAAuC;AACzC;AACA;EACE,yBAAyB;EACzB,sBAAsB;EACtB,YAAY;EACZ,kBAAkB;EAClB,eAAe;EACf,iBAAiB;EACjB,kBAAkB;AACpB;AACA;EACE,YAAY;EACZ,yBAAyB;AAC3B","sourcesContent":["* {\n  box-sizing: border-box;\n}\n:root {\n  --font-sz: 2rem;\n  --accent1: #1a2238;\n  --accent2: #a0aecd;\n  --titleFN-sz: 1.75rem;\n}\n@import url(\"https://fonts.googleapis.com/css2?family=Source+Sans+Pro:ital,wght@0,200;0,300;0,400;0,600;0,700;0,900;1,200;1,300;1,400;1,600;1,700;1,900&display=swap\");\nbody {\n  font-family: \"Source Sans Pro\", sans-serif;\n  background-color: var(--accent2);\n}\n\n.title-pane {\n  background-color: var(--accent1);\n  display: flex;\n  justify-content: center;\n  flex-direction: row;\n  color: white;\n  font-weight: 700;\n  font-style: italic;\n}\n.logo-text-cont {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n}\n.title-Img {\n  width: var(--font-sz);\n  height: var(--font-sz);\n}\n.title-Img.left {\n  margin-right: 15px;\n}\n.title-Img.right {\n  margin-left: 15px;\n}\n.title-text {\n  font-size: var(--font-sz);\n}\n\n.search-card {\n  min-width: 450px;\n  max-width: 500px;\n  padding: 20px;\n  border-radius: 10px;\n  margin: 10px;\n  margin-top: 35px;\n  height: fit-content;\n}\n.shadow-main {\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.19), 0 6px 6px rgba(0, 0, 0, 0.23);\n}\n.search-param {\n  display: flex;\n  flex-direction: column;\n  font-weight: 400;\n  font-size: 1.5rem;\n  margin-top: 15px;\n}\n.search-io {\n  outline: none;\n  border: none;\n  margin-top: 6px;\n  border-bottom: var(--accent1) 2px solid;\n  color: #37497c;\n  padding: 8px 16px;\n  font-size: 1rem;\n}\n.search-title {\n  color: var(--accent1);\n  border-bottom: var(--accent1) 1px solid;\n  font-size: 1.25rem;\n}\n.search-submit-cont {\n  margin-top: 15px;\n  display: flex;\n  justify-content: center;\n}\n#search-submit {\n  border: none;\n  text-align: right;\n  font-weight: 800;\n  text-align: center;\n  font-size: 1.2rem;\n  padding: 15px 25px;\n  background-color: #eba63f;\n}\n#search-submit:hover {\n  background-color: #e40c2b;\n  color: white;\n  padding: 13px 23px;\n  border: var(--accent1) 2px solid;\n}\n.weather-card {\n  min-width: 550px;\n  max-width: 700px;\n  padding: 20px;\n  border-radius: 10px;\n  margin: 10px;\n  margin-top: 35px;\n  background-color: var(--accent1);\n  color: white;\n}\n.weather-card-title {\n  font-size: var(--titleFN-sz);\n  padding-bottom: 10px;\n}\n\n.weather-image-cont {\n  margin: 20px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\n.weather-card-weather-image {\n  --img-sz: 10rem;\n  width: var(--img-sz);\n  height: var(--img-sz);\n  background-color: white;\n  border-radius: 10px;\n}\n\n.weather-image-descrip {\n  font-size: 1.2rem;\n}\n\n.main-flex {\n  display: flex;\n  gap: 10px;\n  justify-content: center;\n}\n.info-flex {\n  display: flex;\n  flex-direction: row;\n}\n.info-col {\n  min-width: 50%;\n  padding: 10px;\n}\n.info-col.left {\n  text-align: right;\n  border-right: white 2px solid;\n  padding-right: 20px;\n}\n.info-col.right {\n  text-align: left;\n  padding-left: 20px;\n}\n.info-col-title {\n  font-size: 1.2rem;\n}\n.temp-text {\n  font-size: 5rem;\n}\n\n.weather-title-flex {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  border-bottom: var(--accent2) 1px solid;\n}\n#tempSwap {\n  height: var(--titleFN-sz);\n  background-color: #fff;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  font-weight: bold;\n  margin-bottom: 5px;\n}\n#tempSwap:hover{\n  color: black;\n  background-color: #eba63f;\n}\n\n\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
